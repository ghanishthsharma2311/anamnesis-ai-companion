...
![Anamnesis Data Entry Interface](screenshots/initial_display.png) 
*A screenshot showing the user interface for entering patient anamnesis data based on the FHIR questionnaire.*

### While Analysing with Transcript
![While Analysing](screenshots/while_analysing_with_transcript.png)
...
### For sharing and exporting to csv  
